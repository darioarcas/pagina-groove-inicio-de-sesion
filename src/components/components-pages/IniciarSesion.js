  ...
  return (
    <>
      ...
      <section className='bg-white my-5 p-3 rounded m-auto ' style={{maxWidth:"300px"}}>
        ...
        <h3 className='text-center text-black mb-4 fw-semibold'>Iniciar sesión</h3>



        {/* <p className='text-black'>Ingresar con Google</p> */}

        <button type="button" className='btn btn-dark w-100 d-flex mb-3' onClick={googleLogin}>
        ...
        <div class="card bg-primary w-100 p-2" id="accordionPanelsStayOpenExample">
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                <span style={{paddingRight:"20px"}}>{MailIcon()}</span> Mail y Contraseña
              </button>
            </h2>
